...
/* Hook functions */
#define configUSE_IDLE_HOOK                     1   // idle task calls loop() → yield() kicks watchdog
...
/* Software timers — DISABLED: timer task at priority 9 with 180-word stack crashes on startup */
